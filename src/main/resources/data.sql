...
-- # Writer
insert into WRITER values (1, 'Moniuszko'),
                                     (2, 'Chopin'),
                                     (3, 'Mozart');
...
-- -- # Albums
-- insert into album values (1, '2011/08/29', 'Vows', 1, 'Australia/New Zealand');
-- insert into album values (2, '2012/05/22', 'Vows', 1, 'North America/European');

-- -- # Albums / Tracks
-- insert into albums_tracks (album_id, tracks_id) values (1,1);
-- insert into albums_tracks values (1,2);
-- insert into albums_tracks values (1,3);
-- insert into albums_tracks values (1,4);
-- insert into albums_tracks values (1,5);
-- insert into albums_tracks values (1,6);
-- insert into albums_tracks values (1,7);
-- insert into albums_tracks values (1,8);
-- insert into albums_tracks values (1,9);
-- insert into albums_tracks values (1,10);
-- insert into albums_tracks values (1,11);
-- insert into albums_tracks values (1,12);-
--
-- insert into albums_tracks values (2,1);
-- insert into albums_tracks values (2,13);
-- insert into albums_tracks values (2,2);
-- insert into albums_tracks values (2,3);
-- insert into albums_tracks values (2,4);
-- insert into albums_tracks values (2,5);
-- insert into albums_tracks values (2,6);
-- insert into albums_tracks values (2,14);
-- insert into albums_tracks values (2,15);
-- insert into albums_tracks values (2,16);
-- insert into albums_tracks values (2,17);
-- insert into albums_tracks values (2,11);
-- insert into albums_tracks values (2,18);